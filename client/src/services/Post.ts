...
export default class Post {
  ...
  static addComment(values: any) {
    setHeaders(instance, values.token, values.id);
    return apiPromise(instance, () =>
      instance.post(baseUrl + `/add-comment`, values.data)
    );
    //   {
    //     "user_id":"670fe49125871392de714531",
    //     "post_id":"67225a06d0bfc8ebd068a9fc",
    //     "comment":"first comment on 9"
    // }
  }
  static getAllCommentByPostId(values: any) {
    setHeaders(instance, values.token, values.id);
    return apiPromise(instance, () =>
      instance.get(baseUrl + `/get-comment/${values.postId}`)
    );
    //   {
    //     "user_id":"670fe49125871392de714531",
    //     "post_id":"67225a06d0bfc8ebd068a9fc"
